...
static const char test_utf8_pabhnha[] = {
    (char) 0xd1, (char) 0x80, (char) 0xd0, (char) 0xb0, (char) 0xd0, (char) 0xb2, (char) 0xd0, 
    (char) 0xbd, (char) 0xd0, (char) 0xb8, (char) 0xd0, (char) 0xbd, (char) 0xd0, (char) 0xb0, 
    '\0'
}; //равнина
static const char test_utf8_madchen[] = {
    'm', (char) 0xc3, (char) 0xa4, 'd','c','h','e','n', 
    '\0'
}; // mädchen
...
namespace NameParsingTests {
    ...
    inline void utf8_parsing() {
        ...
        assert_clean_names("utf8-mayastyle-1", m_p.c_str(), true, 
                           test_utf8_pabhnha, test_utf8_madchen);
...
namespace MaterialNameTests {
    ...
    inline void assert_material_name(const char *msg, const char *mat_full_name,
        ...
        if (mat_correct == NULL)
            ...
            AiMsgError("get_clean_material: Mismatch: ((%s)) Expected %s, was %s", 
...
namespace HashingTests {
    inline void assert_hash_to_float(const char *name, float expected_hash) {
        ...
        if (expected_hash != hash)
            AiMsgError("(f) hash mismatch: (%s) Expected %g, was %g", 
